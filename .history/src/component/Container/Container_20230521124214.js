    ...
    return (
        <div className={cx('groupcate')}>
            ...
            <div className={cx('listgroup')}>
                ...
                <a href="/giay-ve-sinh"> <img width="45" height="45" src="//cdn.tgdd.vn/Products/Images/9081/bhx/giay-ve-sinh-202212051502079595.v202305171357.png" alt="Giấy vệ sinh"> <span>Giấy vệ sinh</span> </a>
            </div>
        </div>
    );
}
