    ...
    return (
        <div className={cx('groupcate')}>
            ...
            <div className={cx('listgroup')}>
                ...
                <a href="/rau-cu-trai-cay"> <img width="45" height="45" src="//cdn.tgdd.vn/Products/Images/10298/bhx/rau-cu-trai-cay-202205261519146845.v202305171357.png" alt="Rau, củ, nấm, trái cây"> <span>Rau, củ, nấm, trái cây</span> </a>
            </div>
        </div>
    );
}
