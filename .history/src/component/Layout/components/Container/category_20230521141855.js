...
function Category() {
    return (
        <div>
            <a href="/thit-heo" className={cx('item')}>
                {' '}
                <img
                    width="45"
                    height="45"
            ...
            <a href="/nuoc-giat" className={cx('item')}>
                {' '}
                <img
                    width="45"
                    height="45"
            ...
            <a href="/nuoc-mam" className={cx('item')}>
                {' '}
                <img
                    width="45"
                    height="45"
            ...
            <a href="/rau-cu-trai-cay" className={cx('item')}>
                {' '}
                <img
                    width="45"
                    height="45"
            ...
            <a href="/sua-tuoi" className={cx('item')}>
                {' '}
                <img
                    width="45"
                    height="45"
            ...
            <a href="/nuoc-ngot" className={cx('item')}>
                {' '}
                <img
                    width="45"
                    height="45"
