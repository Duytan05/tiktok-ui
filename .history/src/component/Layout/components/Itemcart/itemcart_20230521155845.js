...
function ItemCart(props) {
    return (
        ...
        // </div>
        <li
            class="hideExpired vertical product  
                   hasNotUnit  "
            data-type="normal"
            data-product="279674"
            data-sku="1254619000125"
            data-maxqtyonbill="0"
            data-priceonbill="35.000₫"
            data-personalize=""
            data-prestore="0"
            data-podate=""
            data-position="0"
        >
            <a href="/ca-tom-muc-ech/ca-ngu-nuong-vi" title="Cá ngừ nướng 300g">
                <div class="boximg" title="Cá ngừ nướng 300g">
                    <img
                        width="160"
                        height="160"
